...
import com.example.dashbord.Dashboard;
import com.example.dashbord.Profile;
...
public class inventory extends AppCompatActivity implements com.example.tracker.dashAdapter.OnButtonClickListener {

    private ImageView image;
    private RecyclerView recyclerView;
    private ImageButton btnadd,btnbackdash;
    ...
    private void setUI(){
        ...
        btnbackdash = findViewById(R.id.btnbacktodash);

        btnbackdash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(intent = new Intent(inventory.this, Dashboard.class));
...
//        images.add("https://i.imgur.com/53QR2iB_d.webp?maxwidth=760&fidelity=grand");
    ...
    public void onButtonClick(int position) {
        Intent intent1 = new Intent(this, ItemsMain.class);
